  ...
  describe "process! method" do
    context "pdf with no cover" do
      ...
      it "should create the pdf" do
        pdf.render
        expect(File.exist?("./tmp/my-book.pdf")).to be true
      end
    end
    ...
    context "pdf with cover" do
      ...
      context "with local png cover" do
        ...
        it "should copy the image", zip: false do
          pdf.render
          expect(File.exist?("./tmp/my-book/pdf/images/sample-2.png")).to be true
        end
        ...
        it "should generate the html page", zip: false do
          pdf.render
          expect(File.exist?("./tmp/my-book/pdf/cover.html")).to be true
        end

        it "should create the cover", zip: false do
          pdf.render
          expect(File.exist?("./tmp/my-book/pdf/cover.pdf")).to be true
        end
      end
      ...
      context "with remote png cover" do
        ...
        it "should copy the image", zip: false do
          pdf.render
          expect(File.exist?("./tmp/my-book/pdf/images/cover.png")).to be true
        end
      end
